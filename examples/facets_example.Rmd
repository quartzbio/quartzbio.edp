...
---
Facets allows the user to see different types of summaries. For example, facets of a string fields, such as "gene_symbol" returns the 10 most common gene_symbols in the dataset and their counts. Facets, may be used to return percentiles, histograms and statistics depending on the queried field. These are a few examples of how facets can be used in QuartzBio EDP.
