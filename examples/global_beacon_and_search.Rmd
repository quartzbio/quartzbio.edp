...
```{r}
# Login to QuartzBio EDP via API key
library("solvebio")
...
Global Search is available on QuartzBio EDP Mesh. For more information about Global Search please look at [QuartzBio EDP docs](https://docs.solvebio.com/search/).
