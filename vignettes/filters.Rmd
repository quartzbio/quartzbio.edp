...
Dataset_query(dataset_id = MedLine$id, filters = '[["abstract__contains", "diabetes"]]')
```
...
When manually writing queries in JSON, users can combine and nest filters using boolean operators ('and', 'or', 'not').
