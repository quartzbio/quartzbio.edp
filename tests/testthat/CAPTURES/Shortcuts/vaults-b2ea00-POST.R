structure(
  list(
    ...
    headers = structure(
      list(
        date = "Mon, 19 Jan 2026 10:54:28 GMT",
        `content-type` = "application/json",
        `content-length` = "560",
        location = "https://vsim-dev.api.edp.aws.quartz.bio/v2/vaults/3182",
        server = "nginx",
    ...
    content = charToRaw(
      "{\n  \"account_domain\": \"vsim-test-dev\",\n  \"account_id\": 33,\n  \"class_name\": \"Vault\",\n  \"created_at\": \"2026-01-19T10:54:28.034155Z\",\n  \"default_storage_class\": \"Temporary\",\n  \"description\": \"quartzbio.edp R package temp test vault\",\n  \"full_path\": \"vsim-test-dev:quartzbio.edp.test.Shortcuts\",\n  \"has_children\": false,\n  \"has_folder_children\": false,\n  \"id\": 3182,\n  \"is_deleted\": false,\n  \"is_public\": false,\n  \"versioning\": \"disabled\",\n  \"last_synced\": {},\n  \"metadata\": {},\n  \"name\": \"quartzbio.edp.test.Shortcuts\",\n  \"permissions\": {\n    \"read\": true,\n    \"write\": true,\n    \"admin\": true\n  },\n  \"provider\": \"EDP\",\n  \"require_unique_paths\": true,\n  \"tags\": [\n    \"TESTING\"\n  ],\n  \"updated_at\": \"2026-01-19T10:54:28.107975Z\",\n  \"url\": \"https://vsim-dev.api.edp.aws.quartz.bio/v2/vaults/3182\",\n  \"user\": {\n    \"class_name\": \"User\",\n    \"date_joined\": \"2023-01-27T16:17:17.087Z\",\n    \"email\": \"Test.User@fakemail.com\",\n    \"first_name\": \"Test\",\n    \"full_name\": \"Test User\",\n    \"id\": 51,\n    \"is_active\": true,\n    \"is_staff\": false,\n    \"is_verified\": true,\n    \"last_name\": \"User\",\n    \"password_days_remaining\": {},\n    \"role\": \"member\",\n    \"title\": \"\",\n    \"url\": \"https://vsim-dev.api.edp.aws.quartz.bio/v1/users/51\",\n    \"username\": \"mock_user\"\n  },\n  \"user_id\": 243,\n  \"vault_properties\": {},\n  \"vault_type\": \"general\",\n  \"bdm_settings\": {},\n  \"connection\": {},\n  \"connection_data\": {},\n  \"last_sync_time\": {},\n  \"is_favourite\": false\n}"
    ),
    date = structure(1768820068, class = c("POSIXct", "POSIXt"), tzone = "GMT"),
    times = c(
      redirect = 0,
      namelookup = 3e-05,
      connect = 0,
      pretransfer = 0.000115,
      starttransfer = 0.272073,
      total = 0.272339
    )
  ),
  class = "response"
