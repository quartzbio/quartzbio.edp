structure(list(
  ...
  status_code = 201L, headers = structure(list(
    ...
    `content-type` = "application/json", `content-length` = "1692",
  ...
  date = structure(1681396804, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 0.001339,
    connect = 0.001342, pretransfer = 0.001739, starttransfer = 0.001743,
    total = 0.187762
  )
), class = "response")
