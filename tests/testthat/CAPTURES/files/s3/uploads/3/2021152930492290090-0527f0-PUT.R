structure(
  list(
    ...
    times = c(
      ...
      namelookup = 0.000117,
      connect = 0.092864,
      pretransfer = 0.304299,
      starttransfer = 0.304301,
      total = 0.486674
    )
  ),
  class = "response"
