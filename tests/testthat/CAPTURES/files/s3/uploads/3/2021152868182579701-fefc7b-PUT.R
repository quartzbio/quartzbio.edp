structure(
  list(
    ...
    times = c(
      ...
      namelookup = 0.023174,
      connect = 0.115473,
      pretransfer = 0.317453,
      starttransfer = 0.317455,
      total = 0.519001
    )
  ),
  class = "response"
