structure(list(
  ...
  status_code = 201L, headers = structure(list(
    ...
    `content-type` = "application/json", `content-length` = "474",
  ...
  date = structure(1681400990, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 7.1e-05,
    connect = 7.5e-05, pretransfer = 0.000225, starttransfer = 0.000232,
    total = 0.143151
  )
), class = "response")
