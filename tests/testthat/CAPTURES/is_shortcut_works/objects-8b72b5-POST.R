structure(
  list(
    ...
    times = c(
      ...
      namelookup = 5.2e-05,
      connect = 0,
      pretransfer = 0.000172,
      starttransfer = 0.195845,
      total = 0.196086
    )
  ),
  class = "response"
