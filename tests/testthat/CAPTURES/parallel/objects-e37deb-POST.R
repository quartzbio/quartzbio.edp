structure(
  list(
    ...
    times = c(
      ...
      namelookup = 4.5e-05,
      connect = 4.7e-05,
      pretransfer = 0.000163,
      starttransfer = 0.000171,
      total = 0.628071
    )
  ),
  class = "response"
