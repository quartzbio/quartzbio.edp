structure(list(
  ...
  date = structure(1678904304, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 0.084829,
    connect = 0.178684, pretransfer = 0.29716, starttransfer = 0.297168,
    total = 0.465274
  )
), class = "response")
