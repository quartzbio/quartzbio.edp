structure(
  list(
    ...
    times = c(
      ...
      namelookup = 3.8e-05,
      connect = 4.4e-05,
      pretransfer = 0.000148,
      starttransfer = 0.000152,
      total = 0.176423
    )
  ),
  class = "response"
