structure(
  list(
    ...
    times = c(
      ...
      namelookup = 0.001823,
      connect = 0.001826,
      pretransfer = 0.002804,
      starttransfer = 0.00281,
      total = 0.230341
    )
  ),
  class = "response"
