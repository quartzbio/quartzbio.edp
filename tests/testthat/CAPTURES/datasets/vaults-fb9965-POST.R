structure(list(
  ...
  date = structure(1685349765, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 0.172447,
    connect = 0.315888, pretransfer = 0.669128, starttransfer = 0.669199,
    total = 0.887847
  )
), class = "response")
