structure(list(
  url = "https://vsim-dev.api.edp.aws.quartz.bio/v2/objects/whatever",
  ...
  content = charToRaw("{\"detail\": \"Not found\"}"), date = structure(1681400998, class = c(
    "POSIXct",
    "POSIXt"
  ), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 3.4e-05,
    connect = 3.6e-05, pretransfer = 0.000123, starttransfer = 0.098652,
    total = 0.098746
  )
), class = "response")
