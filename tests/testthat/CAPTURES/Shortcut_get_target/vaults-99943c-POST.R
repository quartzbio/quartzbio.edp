  ...
  list(
    ...
    headers = structure(
      list(
        ...
        `content-length` = "569",
        location = "https://vsim-dev.api.edp.aws.quartz.bio/v2/vaults/3178",
        server = "nginx",
    ...
    times = c(
      ...
      namelookup = 2.8e-05,
      connect = 0,
      pretransfer = 0.000113,
      starttransfer = 0.40295,
      total = 0.403068
    )
  ),
  class = "response"
