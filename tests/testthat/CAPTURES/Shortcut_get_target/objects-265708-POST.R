structure(list(url = "https://vsim-dev.api.edp.aws.quartz.bio/v2/objects", 
    status_code = 201L, headers = structure(list(date = "Mon, 19 Jan 2026 10:51:47 GMT", 
        `content-type` = "application/json", `content-length` = "643", 
    ...
    "list")), all_headers = list(list(status = 201L, version = "HTTP/2", 
        headers = structure(list(date = "Mon, 19 Jan 2026 10:51:47 GMT", 
            `content-type` = "application/json", `content-length` = "643", 
            location = "None", server = "nginx", allow = "GET, POST, HEAD, OPTIONS", 
            `x-frame-options` = "SAMEORIGIN", vary = "Authorization, Origin, Accept-Encoding", 
            `content-encoding` = "gzip", `strict-transport-security` = "max-age=31536000; includeSubDomains", 
    ...
    date = structure(1768819907, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.7e-05, 
    connect = 0, pretransfer = 0.000108, starttransfer = 0.227986, 
    total = 0.228224)), class = "response")
