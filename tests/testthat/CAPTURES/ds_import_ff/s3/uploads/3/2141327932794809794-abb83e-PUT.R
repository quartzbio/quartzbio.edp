structure(
  list(
    ...
    times = c(
      ...
      namelookup = 0.017696,
      connect = 0.109769,
      pretransfer = 0.307312,
      starttransfer = 0.30732,
      total = 0.71972
    )
  ),
  class = "response"
