structure(list(
  ...
  content = raw(0), date = structure(1681396809, class = c(
    "POSIXct",
    "POSIXt"
  ), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 7.3e-05,
    connect = 7.5e-05, pretransfer = 0.000198, starttransfer = 0.000202,
    total = 0.125245
  )
), class = "response")
