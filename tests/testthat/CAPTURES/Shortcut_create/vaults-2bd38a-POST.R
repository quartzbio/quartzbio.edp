  ...
  list(
    ...
    headers = structure(
      list(
        ...
        `content-length` = "565",
        location = "https://vsim-dev.api.edp.aws.quartz.bio/v2/vaults/3180",
        server = "nginx",
